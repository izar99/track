...
<div class="row">
	<div class="col-md-4 col-md-offset-3">
		...
		<center><h2 style="margin-top:1px;">Tracking Produk Hukum</h2></center>
			<form class="form-horizontal form-custom-login" action="" method="POST">
			  <div class="form-heading">
			    <h2 class="text-center">GOLANG 3-5</h2>
			  </div>
			  ...
			  <button type="submit" name="login_btn" class="btn btn-success pull-right">Login</button>
			</form>
		</div>
	</div>
</div>
