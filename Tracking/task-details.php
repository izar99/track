        ...
        <div class="well well-custom">
          <div class="row">
            <div class="col-md-8 col-md-offset-2">
              <div class="well">
                <h3 class="text-center bg-primary" style="padding: 7px;">Informasi Dokumen </h3><br>
                        	 ...
                        	 <div class="table-responsive">
				                  <table class="table table-bordered table-single-product">
				                    <tbody>
									  ...
									  <tr>
				                        <td>Dinas</td><td><?php echo $row['dinas']; ?></td>
				                      </tr>
				                      <tr>
				                      ...
				                      <tr>
				                        <td>Delegasi</td><td><?php echo $row['fullname']; ?></td>
				                      </tr>
				                      <tr>
