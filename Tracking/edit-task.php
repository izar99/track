        ...
        <div class="well well-custom">
          <div class="row">
            <div class="col-md-8 col-md-offset-2">
              <div class="well">
                <h3 class="text-center bg-primary" style="padding: 7px;">Edit Progres Dokumen </h3><br>
                          ...
                          <form class="form-horizontal" role="form" action="" method="post" autocomplete="off">
                            <div class="form-group">
			                  ...
			                  <div class="form-group">
								...
								<div class="form-group">
			                    <label class="control-label col-sm-5">Nama Dinas</label>
			                    <div class="col-sm-7">
			                      <input type="text" placeholder="Nama Dinas" id="dinas" name="dinas" list="expense" class="form-control" value="<?php echo $row['dinas']; ?>" <?php if($user_role != 1){ ?> readonly <?php } ?> val required>
			                    </div>
			                  </div>
			                  <div class="form-group">
