    ...
    <div class="modal-dialog add-category-modal">
      ...
      <div class="modal-content">
        <div class="modal-header">
          ...
          <h2 class="modal-title text-center">Input Data Dokumen</h2>
        </div>
              ...
              <form role="form" action="" method="post" autocomplete="off">
                <div class="form-horizontal">
                  <div class="form-group">
                    <label class="control-label col-sm-5">Nama Dokumen</label>
                    <div class="col-sm-7">
                  ...
                  <div class="form-group">
                    ...
                    <label class="control-label col-sm-5">Dinas</label>
                    <div class="col-sm-7">
                      <input type="text" placeholder="Nama Dinas" id="dinas" name="dinas" list="expense" class="form-control" id="default" required>
                    </div>
                  </div>
                  <div class="form-group">
                  ...
                  <div class="form-group">
                    <label class="control-label col-sm-5">Delegasi</label>
                    <div class="col-sm-7">
                      <?php 
                  ...
                  <div class="form-group">
                    <div class="col-sm-offset-3 col-sm-3">
                      <button type="submit" name="add_task_post" class="btn btn-success-custom">Konfirmasi</button>
                    </div>
                    <div class="col-sm-3">
    ...
    <div class="row">
      <div class="col-md-12">
        <div class="well well-custom">
          ...
          <div class="row">
            <div class="col-md-8">
              <div class="btn-group">
                <?php if($user_role == 1){ ?>
                <div class="btn-group">
                  <button class="btn btn-success btn-menu" data-toggle="modal" data-target="#myModal">Input Data</button>
                </div>
              <?php } ?>
          ...
          <center ><h3>Tracking Produk Hukum</h3></center>
          <div class="gap"></div>
            ...
            <table class="table table-codensed table-custom">
              ...
              ?>
                <tr>
                  ...
                  <td>
                    <?php  if($row['status'] == 1){
                        echo "In Progress <span style='color:#5cb85c;' class=' glyphicon glyphicon-refresh' >";
                    }elseif($row['status'] == 2){
